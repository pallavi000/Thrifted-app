...
import { CartNavigation, categoryNavigation, homeNavigation, profileNavigation } from './StackNavigator'
  ...
  return (
    <Tab.Navigator  screenOptions={{
        ...
        <Tab.Screen name="account" component={profileNavigation} options={{
          tabBarIcon:()=>(<Image source={{uri: imageLink+userImage}} style={styles.imageIcon}/>)
        }}/>
