...
export default function CommentNotification(props) {
  ...
  return (
    <View>
      <TouchableOpacity
        onPress={() => navigation.navigate("Comments", item.post._id)}
      ...
      >
        ...
        <View style={styles.detailView}>
          <Text style={styles.detail}>
            <Text style={styles.mention}>{item.follower.name}</Text> and{" "}
            {item.count} others commented on your post.
          </Text>
          <Text style={styles.time}>{format(item.createdAt)}</Text>
        </View>
        <View>
          <Image
            source={{ uri: imageLink + item.post.image }}
