...
export default function ChildCat({navigation}) {
  return (
    <SafeAreaView style={{backgroundColor:'white',flex:1}} >
    <ScrollView >
    <View><Text style={styles.select}>Select Category</Text></View>
    <View style={styles.categoryWrapper}>
    <TouchableOpacity onPress={()=>navigation.navigate('Category Title')}><Text style={styles.name}>Tops</Text></TouchableOpacity>
